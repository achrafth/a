...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($cinExist == null && $emailExist == null && $usernameExist == null && $phoneExist == null)
        {
            ...
            $mail->Body = 'Veuillez cliquez sur ce  <a href="localhost/pidev/cores/verification.php?cin='.$cin.'&token='.$token.'">lien</a> afin d\'activer votre compte';
...
?>
              ...
              <form class="signup" action="" method="post">
                ...
                <div class="form-group">
                  <button id="signup" onclick="verifier(event)"  class="btn btn-success btn-block" name="submit" >
                      SUBMIT
                  </button>
                </div>
              </form>

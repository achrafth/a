...
<div class="content">
    <div class="container">
        <div class="jumbotron" style="padding: 1rem 2rem">
            <h3 class="text-center" style="font-weight: 600">Livreurs</h3>
        </div>
        <div class="row">
                ...
                <form action="" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-search" style="border-radius: 5px" type="button"><i class="fa fa-search fa-fw"></i></button>
                          </span>
                    </div>
                </form>
            </div>

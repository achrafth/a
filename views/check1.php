		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment" method="POST" action="ajoutlivreur.php">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="date" name="date" placeholder="date" required>
						</div>
							<label class="control-label">debut contrat *</label>
						<div class="bo4 of-hidden size15 m-b-20">

							<input class="sizefull s-text7 p-l-22 p-r-22" type="date" name="debutc" placeholder="debutc" required>
						</div>
							<label class="control-label">fin contrat *</label>
						<div class="bo4 of-hidden size15 m-b-20">

							<input class="sizefull s-text7 p-l-22 p-r-22" type="date" name="finc" placeholder="finc" required>
						</div>
						...
						<!--/div-->
						<label class="control-label">code livreur *</label>
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="codel" placeholder="codel" required>
						</div>
				...
				<table class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												<tabody><tr>
													...
													<th class="text-center">debutc</th>
